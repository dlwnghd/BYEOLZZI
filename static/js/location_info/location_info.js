...
// 여행지정보 함수
function location_info_ajax(NerList) {   
  ...
  let url = `https://travel.naver.com/domestic/${location_no}/summary`;

  $("#iframe").attr("src", "location_info?url=" + url)


  /*
  // 관광공사 api //
  let serviceKey = 'Ul3IcC3GYJtiUBYL%2F2%2BB7ZUHN3kFiPQMzyL1mnEl19s8RZfQDpXs50hWwJw4SovDGQ7afYNXvS6WhgJLsSD2AA%3D%3D';  // 인증키 
  let pageNo = 1;              // 페이지 번호 
